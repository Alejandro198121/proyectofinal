...
public class Controller implements ActionListener {
    ...
    public void asignarOyentes() {
        ...
        cupoLiberacion.getBotonOk().addActionListener(this);
        cupoLiberacion.getBotonSalir().addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (comando.equals("INICIAR_SESION")) {
            ...
            if (!datosCorrectos) {
                ...
                for (int i = 0; i < directorioClientes.getDirectorioClientes().size(); i++) {
                    if (ventanaLogin.getPanelSesion().getCampoUsuario().getText().equals(directorioClientes.getDirectorioClientes().get(i).getUsuario()) && ventanaLogin.getPanelSesion().getCampoContrasena().getText().equals(directorioClientes.getDirectorioClientes().get(i).getContrasena())) {
                        this.cliente=directorioClientes.getDirectorioClientes().get(i);
                ...
                for (int i = 0; i < directorioClientes.getDirectorioClientes().size(); i++) {
                    for(int j=0; j<directorioparejas.size(); i++){
                        
                        if (ventanaLogin.getPanelSesion().getCampoUsuario().getText().equals(directorioClientes.getDirectorioClientes().get(i).getParejascliente().get(j).getUsuario()) && ventanaLogin.getPanelSesion().getCampoContrasena().getText().equals(directorioClientes.getDirectorioClientes().get(i).getParejascliente().get(j).getContrasena())) {
                        System.out.println(pareja.toString());
                        this.pareja=directorioparejas.get(i);
                        ventanaLogin.setVisible(false);
                    ...
                    if (ventanaLogin.getPanelSesion().getCampoUsuario().getText().equals(directorioClientes.getDirectorioClientes().get(i).recorrerParejasususario()) && ventanaLogin.getPanelSesion().getCampoContrasena().getText().equals(directorioparejas.get(i).getContrasena())) {
                        System.out.println(pareja.toString());
                        this.pareja=directorioparejas.get(i);
                        ventanaLogin.setVisible(false);
                        superMercado.setVisible(true);
            ...
            if (menuadmin.getOpciones().getSelectedItem().equals("REGISTRO DE TIENDAS DE MERCADO (ALMACENES)")) {
                ...
                for (Cliente x : directorioClientes.getDirectorioClientes()) {
                    String useraux = x.getUsuario();
                    cupoLiberacion.getClientes().addItem(useraux + " debe: "+ x.getDeuda());
                }
            ...
            int sumaTotal = ((superMercado.getEntero1() * 1000000) + (superMercado.getEntero2() * 2000000) + (superMercado.getEntero3() * 1000000) + (superMercado.getEntero4() * 5000000) + (superMercado.getEntero5() * 3000000) + (superMercado.getEntero6() * 9000000));
            superMercado.geteTotal().setText("Total: " + sumaTotal + "$");
        }else if(comando.equals("SALIRLIBERACIONCUPO")){
            cupoLiberacion.setVisible(false);
            menuadmin.setVisible(true);
        }else if(comando.equals("BOTON_LIBERACIONCUPO")){
           directorioClientes.getDirectorioClientes().get(cupoLiberacion.getClientes().getSelectedIndex()).setDeuda(0);
           directorioClientes.getDirectorioClientes().get(cupoLiberacion.getClientes().getSelectedIndex()).setTarjetaCredito(directorioClientes.getDirectorioClientes().get(cupoLiberacion.getClientes().getSelectedIndex()).getCantmaxcupo()+"");
           System.out.println(directorioClientes.getDirectorioClientes().get(cupoLiberacion.getClientes().getSelectedIndex()).toString());
           cupoLiberacion.setVisible(false);
           menuadmin.setVisible(true);
            ...
            if (pareja.getCupo() >= sumaTotal) {
                ...
                System.out.println(cliente.getTarjetaCredito());
                System.out.println(pareja.getDineroGastado());
                cliente.setTarjetaCredito((Double.parseDouble(cliente.getTarjetaCredito()) - pareja.getDineroGastado())+"");
                cliente.setDeuda(pareja.getDineroGastado());
                
                System.out.println(pareja.getCupo() + "   " + pareja.getDineroGastado() + "   " + cliente.getTarjetaCredito() + "     " + cliente.getDeuda());
            } else {
                ...
                if (aux == 0) {
                    ...
                    cliente.setSobrecupo(Double.parseDouble(cliente.getTarjetaCredito()));
                    ...
                    pareja.setDineroGastado(sumaTotal);
                    pareja.setCupo((pareja.getCupo() - pareja.getDineroGastado()));
                    cliente.setTarjetaCredito((Double.parseDouble(cliente.getTarjetaCredito()) - sumaTotal)+"");
                    cliente.setDeuda((cliente.getSobrecupo() - Double.parseDouble(cliente.getTarjetaCredito())));
                    System.out.println(pareja.getCupo() + "   " + pareja.getDineroGastado() + "   " + cliente.getTarjetaCredito() + "     " + cliente.getDeuda());
